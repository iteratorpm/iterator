module ProjectsHelper
  ...
  def panel(panel_id, velocity: false, add_story: false, close: false, actions: false, add_label: false, title: nil, &block)
    turbo_frame_tag panel_id do
      content_tag(:div, class: "flex flex-col h-full bg-gray-50 min-w-2xs overflow-hidden",
        ...
        safe_join([
          render("projects/panel_header", velocity: velocity, add_story: add_story, add_label: add_label, close: close,
